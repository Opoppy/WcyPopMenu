...
NSString *const kPopMenuItemAttributeTitle    = @"PopMenuItemAttributeTitle";
NSString *const kPopMenuItemAttributeIconImageName    = @"PopMenuItemAttributeIconImageName";

@interface WcyPopMenuItem ()<CAAnimationDelegate>
@end
@implementation WcyPopMenuItem
...
- (void)setAttrDic:(NSMutableDictionary *)attrDic {
    ...
    NSString *imageName = [attrDic objectForKey:kPopMenuItemAttributeIconImageName];
    UIImage *image = [UIImage imageNamed:imageName];
    [self setImage:image forState:UIControlStateNormal];
    
    NSString *title = [attrDic objectForKey:kPopMenuItemAttributeTitle];
